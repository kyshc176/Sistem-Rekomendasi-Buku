...
Original file is located at
    https://colab.research.google.com/drive/10W9SZkEB3MWnUko-IYWsLR1XQ0D_TqFl
...
Namun, ditemukan bahwa kolom `Year-Of-Publication` bertipe **object**, padahal semestinya bertipe **integer**, karena merepresentasikan tahun terbit. Oleh karena itu, perlu dilakukan **konversi tipe data** ke format numerik (integer) sebagai langkah awal pembersihan data.
...
### Langkah selanjutnya:
Hapus baris yang mengandung nilai teks pada kolom `Year-Of-Publication`, lalu ubah tipe data kolom tersebut menjadi integer.
"""
